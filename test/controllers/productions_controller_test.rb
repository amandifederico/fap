...
class ProductionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create production" do
    assert_difference('Production.count') do
      post productions_url, params: { production: { description: @production.description, troop_id: @production.troop_id } }
    end
  ...
  test "should update production" do
    patch production_url(@production), params: { production: { description: @production.description, troop_id: @production.troop_id } }
