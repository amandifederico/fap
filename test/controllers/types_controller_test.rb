...
class TypesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create type" do
    assert_difference('Type.count') do
      post types_url, params: { type: { animal_type_id: @type.animal_type_id, description: @type.description, name: @type.name } }
    end
  ...
  test "should update type" do
    patch type_url(@type), params: { type: { animal_type_id: @type.animal_type_id, description: @type.description, name: @type.name } }
